...
const Landing = ({ setSelectedPage }) => {
  return (
    <section id="home" className="md:flex  gap-16 md:h-full py-10">
      <div className="z-30  mt-20 md:mt-32">
        ...
        >
          ...
          <p className="mt-10  mb-7 text-sm md:text-base md:w-[70%] text-start">
            A recent graduate with a degree in Master's of Science in Data
            Science and experience as a data analyst transforming complexity
            into clarity, one data point at a time.
          </p>
        </motion.div>
        {/* CALL TO ACTIONS */}
        <motion.div
        ...
        >
          <a
            ...
            href="/assets/RESUME_SHARONBEULAH_PERUMANDLA.pdf"
            target="_blank"
            download="Resume_SharonBeulah_Perumandla.pdf"
          >
            Resume
          </a>
          <AnchorLink
